...
//
// Related Topics 栈 树 深度优先搜索 二叉树 👍 2293 👎 0
 ...
 *
 * @author XuJ
 * @date 2025-09-08 14:23:07
 */
class P94_BinaryTreeInorderTraversal {
    public static void main(String[] args) {
        //测试代码
        Solution solution = new P94_BinaryTreeInorderTraversal().new Solution();
        List<Integer> list = solution.inorderTraversal(TreeNode.createRoot(new Integer[]{1,null,2,null,null,3,null}));
