...
//
//
// Related Topics 树 深度优先搜索 广度优先搜索 二叉树 👍 1470 👎 0
 ...
 *
 * @author XuJ
 * @date 2025-08-26 15:56:36
 */
class P617_MergeTwoBinaryTrees {
    public static void main(String[] args) {
        //测试代码
        Solution solution = new P617_MergeTwoBinaryTrees().new Solution();
        solution.mergeTrees(TreeNode.createRoot(new Integer[]{1, 3, 2, 5}), TreeNode.createRoot(new Integer[]{2, 1, 3, null, 4, null, 7}));
    }
